...
/// Offset of target grace entity ID in GameMan structure (fast travel destination)
/// This is only valid while warp_requested is true; it gets cleared after the warp
