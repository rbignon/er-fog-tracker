...
async function processSpoilerLogText(text) {
    ...
    if (!hasFogPatterns && !hasScaling) {
        if (text.includes('-- Item preset')) {
            throw new Error(
                'This appears to be an Item Randomizer spoiler log, not a Fog Randomizer log. Please load a spoiler log from the Fog Gate Randomizer mod.'
            );
        }
        if (text.includes('-- Enemy preset')) {
            throw new Error(
                'This appears to be an Enemy Randomizer spoiler log, not a Fog Randomizer log. Please load a spoiler log from the Fog Gate Randomizer mod.'
            );
        }
        throw new Error(
            "This does not appear to be a valid Fog Randomizer spoiler log. Make sure you're loading the spoiler log generated by the Fog Gate Randomizer mod."
        );
    }
